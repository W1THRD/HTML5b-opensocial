...
let musicSound = new Audio('https://cdn.jsdelivr.net/gh/w1thrd/HTML5b-opensocial@aa0e10f/data/the fiber 16x loop.wav');
...
async function loadingScreen() {
	...
	let req = await fetch('https://cdn.jsdelivr.net/gh/w1thrd/HTML5b-opensocial@aa0e10f/data/levels.txt');
	levelsString = await req.text();
	loadLevels();

	req = await fetch('https://cdn.jsdelivr.net/gh/w1thrd/HTML5b-opensocial@aa0e10f/data/images2.json');
